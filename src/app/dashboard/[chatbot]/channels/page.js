...
export default async function ChannelsPage({ params }) {
  ...
  const integrations = [
    {
      id: "whatsapp",
      title: "WhatsApp Business by Wazend",
      description: "Conecta tu WhatsApp al instante escaneando un código QR. La forma más rápida de empezar.",
      image: "/social/wazend.png",
      integrationUrl: `/dashboard/${chatbotSlug}/integrations/whatsapp`,
    },
    {
      id: "messenger",
      title: "Messenger",
      description: "Conecta tu página de Facebook para responder automáticamente a tus clientes.",
      image: "/social/messenger.png",
      isComingSoon: true,
    },
    {
      id: "instagram",
      title: "Instagram",
      description: "Gestiona tus DMs y comentarios de Instagram directamente desde aquí.",
    ...
    },
    {
      id: "tiktok",
      title: "TikTok",
      description: "Interactúa con tu audiencia en TikTok y gestiona tus mensajes.",
    ...
    },
    {
      ...
      description: "Utiliza la API oficial de WhatsApp para una integración más robusta.",
