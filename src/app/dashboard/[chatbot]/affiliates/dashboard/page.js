...
export default function AffiliateDashboardPage({ params }) {
  const chatbotSlug = params?.chatbot || "";
  const basePath = chatbotSlug ? `/dashboard/${encodeURIComponent(chatbotSlug)}` : "/dashboard";
  const activationHref = `${basePath}/affiliates`;
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" asChild>
            <Link href={activationHref}>Ver enlace / activar</Link>
          </Button>
