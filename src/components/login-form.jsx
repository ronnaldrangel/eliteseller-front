      ...
      <FieldGroup>
        ...
        <Field>
          <div className="flex items-center">
            ...
            <a href="/auth/forgot-password" className="ml-auto text-sm text-white underline-offset-4 hover:underline">
        ...
        <Field>
          ...
          <FieldDescription className="text-center text-white pt-4">
